package com.example.kylinarm.searchviewdemo.GenerateQRCode.zbar;
...
import com.example.kylinarm.searchviewdemo.GenerateQRCode.zbar.camera.CameraManager;
import com.example.kylinarm.searchviewdemo.GenerateQRCode.zbar.decode.MainHandler;
import com.example.kylinarm.searchviewdemo.GenerateQRCode.zbar.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    private static int REQUESTCODE_RETURN=2;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        super.onRequestPermissionsResult(REQUESTCODE_RETURN, permissions, grantResults);
    }
